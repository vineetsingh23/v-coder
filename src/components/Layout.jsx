...
const Navbar = () => {
  return (
    <>
      <nav
        className="w-full font-sans bg-slate-950 flex justify-between
       py-3 px-20 fixed top-0 left-0 text-white rounded-b-md items-center shadow-xl shadow-slate-500"
      >
        <div className="flex">
